...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@amora.lk">info@amora.lk</a></li>
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">Ankara Waterfront <p class="logo_w3l_agile_caption">Panadura</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">ANKARA</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
					...
					<ul class="slides">
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Thank you "ANKARA" for helping us to make our special day so memorable! We really appreciate your organization and flexibility to take care of our needs during a very busy day. </p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2022 ANKARA . All Rights Reserved | Design by <a href="index.php">GROUP 10</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
